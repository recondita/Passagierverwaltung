...
public class Steuerung
{
    ...
    private String aEntfernung[][]={{"Berlin","100"},{"New York", "5000"}}; //string weil da ein text ist
    ...
    public void neueBuchung(String pname, String pVorname, String pDatum, String pReiseziel)
    {
    }
